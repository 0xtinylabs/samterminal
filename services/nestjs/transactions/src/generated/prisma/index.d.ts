...
export namespace Prisma {
  ...
  */
  ...
  export type TransactionLogCountAggregateOutputType = {
    ...
    transactionParams: number
    transactionResultParams: number
    errorMessage: number
  ...
  export type TransactionLogCountAggregateInputType = {
    ...
    connectionKey?: true
    connectionValue?: true
    transactionParams?: true
    transactionResultParams?: true
    errorMessage?: true
    transactionStatus?: true
    createdAt?: true
    updatedAt?: true
  ...
  export type TransactionLogGroupByOutputType = {
    ...
    transactionParams: JsonValue | null
    transactionResultParams: JsonValue | null
    errorMessage: string | null
  ...
  export type TransactionLogSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    transactionResultParams?: boolean
  ...
  export type TransactionLogOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "txHash" | "connectionKey" | "connectionValue" | "transactionParams" | "transactionResultParams" | "errorMessage" | "transactionStatus" | "createdAt" | "updatedAt", ExtArgs["result"]["transactionLog"]>
  ...
  export type $TransactionLogPayload<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    ...
    scalars: $Extensions.GetPayloadResult<{
      ...
      connectionKey: string
      connectionValue: string
      transactionParams: Prisma.JsonValue | null
      transactionResultParams: Prisma.JsonValue | null
      errorMessage: string | null
      transactionStatus: $Enums.TransactionStatus
      createdAt: Date
      updatedAt: Date
  ...
  interface TransactionLogFieldRefs {
    ...
    readonly txHash: FieldRef<"TransactionLog", 'String'>
    readonly connectionKey: FieldRef<"TransactionLog", 'String'>
    readonly connectionValue: FieldRef<"TransactionLog", 'String'>
    readonly transactionParams: FieldRef<"TransactionLog", 'Json'>
    readonly transactionResultParams: FieldRef<"TransactionLog", 'Json'>
    readonly errorMessage: FieldRef<"TransactionLog", 'String'>
    readonly transactionStatus: FieldRef<"TransactionLog", 'TransactionStatus'>
  ...
  export type TransactionLogWhereInput = {
    ...
    txHash?: StringFilter<"TransactionLog"> | string
    connectionKey?: StringFilter<"TransactionLog"> | string
    connectionValue?: StringFilter<"TransactionLog"> | string
    transactionParams?: JsonNullableFilter<"TransactionLog">
    transactionResultParams?: JsonNullableFilter<"TransactionLog">
    errorMessage?: StringNullableFilter<"TransactionLog"> | string | null
    transactionStatus?: EnumTransactionStatusFilter<"TransactionLog"> | $Enums.TransactionStatus
  ...
  export type TransactionLogOrderByWithRelationInput = {
    ...
    connectionValue?: SortOrder
    transactionParams?: SortOrderInput | SortOrder
    transactionResultParams?: SortOrderInput | SortOrder
  ...
  export type TransactionLogScalarWhereWithAggregatesInput = {
    ...
    txHash?: StringWithAggregatesFilter<"TransactionLog"> | string
    connectionKey?: StringWithAggregatesFilter<"TransactionLog"> | string
    connectionValue?: StringWithAggregatesFilter<"TransactionLog"> | string
    transactionParams?: JsonNullableWithAggregatesFilter<"TransactionLog">
    transactionResultParams?: JsonNullableWithAggregatesFilter<"TransactionLog">
    errorMessage?: StringNullableWithAggregatesFilter<"TransactionLog"> | string | null
    transactionStatus?: EnumTransactionStatusWithAggregatesFilter<"TransactionLog"> | $Enums.TransactionStatus
  ...
  export type TransactionLogCreateInput = {
    ...
    connectionKey: string
    connectionValue: string
    transactionParams?: NullableJsonNullValueInput | InputJsonValue
    transactionResultParams?: NullableJsonNullValueInput | InputJsonValue
    errorMessage?: string | null
    transactionStatus: $Enums.TransactionStatus
  ...
  export type TransactionLogUpdateInput = {
    ...
    connectionValue?: StringFieldUpdateOperationsInput | string
    transactionParams?: NullableJsonNullValueInput | InputJsonValue
    transactionResultParams?: NullableJsonNullValueInput | InputJsonValue
  ...
  export type TransactionLogCountOrderByAggregateInput = {
    ...
    connectionKey?: SortOrder
    connectionValue?: SortOrder
    transactionParams?: SortOrder
    transactionResultParams?: SortOrder
